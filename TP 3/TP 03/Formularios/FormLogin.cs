...
namespace Formularios
{
    ...
    { 
        ...
        {
            if (Login.ValidarIngreso(txtUsuario.Text, txtPassword.Text))
            {
        ...
        private void AutoCompletarCampos()
        {
            ...
            switch (autocompletarAdministrador)
            {
                case DialogResult.Yes:
                    Login.CargarInformacion(true,out usuario, out password);
                    break;
                case DialogResult.No:
                    Login.CargarInformacion(false,out usuario, out password);
                    break;
                default:
                    return;
            }

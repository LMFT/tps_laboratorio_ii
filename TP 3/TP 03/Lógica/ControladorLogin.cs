...
namespace Logica.Login
{
    public static class ControladorLogin
    {
        ...
        {
            Usuario usuario = CasaElectronica.BuscarUsuario(nombreUsuario);
        ...
        public static void CargarInformacion(bool esAdministrador, out string nombreUsuario, out string password)
        {
            ...
            auxiliar = CasaElectronica.ObtenerUsuario(esAdministrador); 
            
            if(auxiliar is not null)
            {
                nombreUsuario = auxiliar.NombreUsuario;
                password = GetPassword(auxiliar);
            }
        }
        /// <summary>
